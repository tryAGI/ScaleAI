...
{
    /// <inheritdoc />
    public sealed class CreateProjectRequestTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::ScaleAI.CreateProjectRequestType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::ScaleAI.CreateProjectRequestTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
