...
namespace ScaleAI
{
    public partial class ScaleAIClient
    {
        ...
        partial void PrepareUpdateTaskUniqueIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string taskId,
            global::ScaleAI.UpdateUniqueIdRequest request);
        partial void ProcessUpdateTaskUniqueIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateTaskUniqueIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::ScaleAI.Task> UpdateTaskUniqueIdAsync(
            string taskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::ScaleAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::ScaleAI.AutoSDKHttpResponse<global::ScaleAI.Task>> UpdateTaskUniqueIdAsResponseAsync(
            string taskId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateTaskUniqueIdArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::ScaleAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::ScaleAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateTaskUniqueId",
                                methodName: "UpdateTaskUniqueIdAsync",
                                pathTemplate: "$\"/task/{taskId}/unique_id\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateTaskUniqueIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::ScaleAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateTaskUniqueIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateTaskUniqueIdAsync(
                taskId: taskId,
                request: __request,
                requestOptions: requestOptions,
