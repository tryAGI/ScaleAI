...
namespace ScaleAI
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::ScaleAI.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::ScaleAI.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::ScaleAI.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::ScaleAI.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::ScaleAI.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::ScaleAI.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::ScaleAI.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::ScaleAI.ApiException exception)
        ...
        private static global::ScaleAI.AutoSDKRequestOptions CloneRequestOptions(
            global::ScaleAI.AutoSDKRequestOptions? source)
        {
            var clone = new global::ScaleAI.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
